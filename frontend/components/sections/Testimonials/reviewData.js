...
export const TESTIMONIALS_ROW_1 = [
  ...
  },
  {
    ...
    institution: 'Narayana Tech Systems',
    review:
      'The performance tracking is incredibly detailed. We can see each API service’s latency trajectory, identify which nodes are slipping, and intervene early. The AI workload predictions have been surprisingly accurate.',
    avatar: null,
  },
]
...
export const TESTIMONIALS_ROW_2 = [
  ...
  },
  {
    name: 'Sarah Jenkins',
    role: 'Head of Growth',
    institution: 'Acme Scale',
    review:
      'The team analytics dashboard changed how we evaluate operational effectiveness. We can now see user feedback metrics alongside automation throughput. It brought accountability without micro-managing.',
    avatar: null,
  },
  {
    name: 'Rohan Patel',
    role: 'DevOps Engineer',
    institution: 'Vidya Networks',
    review:
      'I love the automated alert routing. The team stays informed with slack alerts without my manual script triggers. The dashboard shows cluster health over time, keeping us updated on our infrastructure.',
    avatar: null,
  },
  {
    name: 'Meera Iyer',
  ...
  },
  {
    name: 'Aditya Singh',
    role: 'Founder & CEO',
    institution: 'Pinnacle Analytics',
    review:
      'The AI-powered workload insights blew my mind. It predicted which nodes were likely to bottleneck, and we scaled proactively. Our overall system retention rate improved by 22% in the first quarter.',
    avatar: null,
  },
  {
    name: 'Divya Krishnan',
