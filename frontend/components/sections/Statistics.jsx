...
const Statistics = () => {
  ...
  const stats = [
    { number: '10,000', suffix: '+', description: 'Workflow tokens executed daily' },
    { number: '120', suffix: '+', description: 'Enterprise team integrations' },
    { number: '24', suffix: '', description: 'Active cloud server regions' },
    { number: '3', suffix: '×', description: 'Increase in deployment velocity' },
  ]
  ...
  return (
    <section 
      ref={sectionRef}
      id="statistics-strip" 
      className={`py-20 md:py-32 lg:py-40 relative overflow-hidden ${isDark ? 'bg-[#000000]' : 'bg-[#f8fafc]'}`}
    >
      <NoiseLayer />
      <BackgroundGrid variant="line" opacity={isDark ? 0.03 : 0.015} size={80} />
      <AmbientGlow color={isDark ? 'rgba(99, 102, 241, 0.05)' : 'rgba(99, 102, 241, 0.02)'} size="45rem" top="50%" left="50%" delay={2} />
