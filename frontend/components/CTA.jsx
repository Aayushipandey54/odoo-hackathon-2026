...
const CTA = () => {
  ...
  const bgClass = isDark ? 'bg-gradient-to-b from-[#030307] to-[#000000]' : 'bg-gradient-to-b from-[#eef2ff] via-white to-white'
  ...
  return (
    ...
    >
      ...
      <AmbientGlow color={isDark ? 'rgba(99, 102, 241, 0.05)' : 'rgba(99, 102, 241, 0.02)'} size="45rem" top="50%" left="50%" delay={0} />
