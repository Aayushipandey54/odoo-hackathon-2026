...
const footerLinks = {
  ...
  Platform: ['Workflow Engine', 'Analytics', 'Security', 'Integrations'],
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 md:gap-8 relative z-10">
          ...
          <div className="md:col-span-2 space-y-8">
            ...
            <p className={`text-sm leading-relaxed max-w-xs ${textColor}`}>
              Architecting the future of enterprise infrastructure. 
              Engineering clarity for modern teams through intelligent systems.
            </p>
