...
export default function AppLayout() {
  ...
  const navItems = [
    ...
    { label: 'Allocations', path: '/app/allocations', icon: ArrowRightLeft },
    { label: 'Transfers', path: '/app/transfers', icon: ArrowRightLeft },
    { label: 'Approvals', path: '/app/approvals', icon: ShieldCheck },
